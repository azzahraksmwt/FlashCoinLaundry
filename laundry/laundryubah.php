                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="nolaundry" name="nolaundry" value="<?php echo $data['nolaundry'];?>" readonly>
                    </div>
                    <div class="mb-3">
                      ...
                      <?php
                        ...
                        $selected = ($row['idcustomer'] == $data['idcustomer']) ? 'selected' : '';
                        echo '<option value="' . $row['idcustomer'] . '" ' . $selected . '>' . $row['customer'] . '</option>';
                        }
                      ?>
                       </select>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <?php
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                        $selected = ($row['userid'] == $data['userid']) ? 'selected' : '';
                        echo '<option value="' . $row['userid'] . '" ' . $selected . '>' . $row['user'] . '</option>';
                        }
                      ?>
                      </select>
                    </div>
...
if (isset($_POST['proses'])) {
    ...
    mysqli_query($conn, "update laundry set idcustomer='$idcustomer', tgl='$tgl', userid='$userid', jam='$jam' where nolaundry='$nolaundry'");
    mysqli_close($conn);

    echo '<script>window.location.href = "laundry.php";</script>';
    exit;
}
?>
